...
We need `r ((total_wells(3, 3,1,1,2)* drug_vol)/number_drug_preparations)`uL per drug preparation and the solution will be diluted 1:2 with the cells. Make
0.8mL to have extra.
...
PMA<-how_much_to_use(100, 0.1, mL_OF_2X_DRUG)
Iono<- how_much_to_use(350,uM_to_ug_per_mL(709.018,2), mL_OF_2X_DRUG)
T20<-round(uL_OF_2X_DRUG / 22.5, digits = 2)

Bryo<-how_much_to_use(2000, 20, mL_OF_2X_DRUG)

# need to add DMSO to match the highest amount of DMSO in a drug condition
DMSO<-max(PMA + Iono, Bryo)
...
R10: Bring to `r mL_OF_2X_DRUG`mL with R10:
