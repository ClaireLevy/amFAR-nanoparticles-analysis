...
message("what is the concentration of Ingenol nanoparticles??? this isn't right!!!!!")
...
Resuspend each formulation of the nanoparticles in R10 to `r Ing_NP_ug/Ing_NP_mL`ug/mL. Vortex and sonicate until there are no clumps. The below procedure will need to be repeated for each formulation.

Use `r Ing_NP_single` uL, bring to `r mL_OF_6X_DRUG`mL with R10 by adding `r mL_OF_6X_DRUG * 1000 - Ing_NP_single`uL
