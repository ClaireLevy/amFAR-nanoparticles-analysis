...
**Goal**
Measure (by flow) genes reported to be regulated by JQ1 and Ingenol.
References:
Darcis et al, doi: 10.1371/journal.ppat.1005063
Banerjee et al: doi: 10.1189/jlb.0312165
...
4. Ingenol-3 nanoparticles 

5. Both JQ1 and Ingenol-3 nanoparticles

6. JQ1 free drug

7. Ingenol-3 free drug

8. Both JQ1 and Ingenol-3 free drug
...
**Donors**
2 x HIV- , total PBMC 
150k cells per well x `r NUMBER_OF_WELLS` wells = 22.8E6 needed.
...
PMA<-how_much_to_use(100, 0.4, mL_OF_2X_CNTL)

#Ionomycin: stock = 350ug/mL, want 4uM,  2x of final concentration.
Iono<- how_much_to_use(350,uM_to_ug_per_mL(709.018,4), mL_OF_2X_CNTL)
...
R10: Bring to `r mL_OF_2X_CNTL`mL with R10 by adding `r uL_OF_2X_CNTL - (PMA + Iono) `uL
...
Ing_NP_single<-how_much_to_use(Ing_NP_ug/Ing_NP_mL,1.296, mL_OF_6X_DRUG)
...
Use `r Ing_FD_single * 100` uL, bring to `r mL_OF_6X_DRUG`mL with R10 by adding `r uL_OF_6X_DRUG - (Ing_FD_single *100)`uL
...
Resuspend the nanoparticles in R10 to `r Ing_NP_ug/Ing_NP_mL`ug/mL. Vortex and sonicate until there are no clumps.

Use `r Ing_NP_single` uL, bring to `r mL_OF_6X_DRUG`mL with R10 by adding `r uL_OF_6X_DRUG - (Ing_NP_single * 100)`uL




```{r JQ1 concentrations}

#JQ starting concentration for free drug single = 4.12ug/mL
#Need 6X, 24.72ug/mL

JQ1_FD_single<-how_much_to_use(1250,24.72, mL_OF_6X_DRUG)

#JQ starting concentration for LCNP single = 6.12ug/mL
#Need 6X, 36.72ug/mL
...
JQ1_NP_single<-how_much_to_use(JQ1_NP_ug/JQ1_NP_mL,36.72, mL_OF_6X_DRUG)

```
**6X JQ1 free drug single**

Use `r JQ1_FD_single`uL, bring to `r mL_OF_6X_DRUG`mL with R10 by adding `r uL_OF_6X_DRUG - JQ1_FD_single`uL


**6X JQ1 NP single**
Resuspend the nanoparticles in R10 to `r JQ1_NP_ug/JQ1_NP_mL`ug/mL. Vortex and sonicate until there are no clumps.

Use `r JQ1_NP_single`uL bring to `r mL_OF_6X_DRUG`mL with R10 by adding `r uL_OF_6X_DRUG - JQ1_NP_single`uL



**6X combintion of free drugs**

Remember to use the 1:100 diluted Ing_FD

Use `r Ing_FD_single *100` uL 1:100 Ing_FD and `r JQ1_FD_single`uL JQ1_FD,  bring to `r mL_OF_6X_DRUG`mL with R10 by adding `r uL_OF_6X_DRUG - ((Ing_FD_single * 100) +JQ1_FD_single)`uL


**6X combintion of NP**

Use `r Ing_NP_single` uL Ing_NP and `r JQ1_NP_single`uL JQ1_NP,  bring to `r mL_OF_6X_DRUG`mL with R10 by adding `r uL_OF_6X_DRUG - (Ing_NP_single +JQ1_NP_single)`uL
...
1. Prepare staining reagent: `r NUMBER_OF_WELLS` µL CXCR4 BUV396 + `r 49*NUMBER_OF_WELLS` µL FACS Wash.
1. Spin cells at 750g for 3 minutes.
1. Resuspend cells in 45 µL staining reagent (this accounts for overage). 
1. Incubate in the dark at **37C** in the incubator for 20 min.
1. Add 150 µL FACS Wash to each well. 
...
* `r NUMBER_OF_WELLS * 2.5` µL CD28 PE		
* `r NUMBER_OF_WELLS * 2.5` µL CD69 APC		
* `r NUMBER_OF_WELLS * 2.5` µL HLA-DR FITC	
* `r NUMBER_OF_WELLS * 0.5` µL CD4 ECD
* `r NUMBER_OF_WELLS * 0.675` µL CD40L APC-e780
* `r NUMBER_OF_WELLS * 31` µL FACS Wash.
